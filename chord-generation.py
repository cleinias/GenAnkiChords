...
#                 \new Staff \relative { \clef bass sol,1 }
#  >>
#
...
for chordItem in chordsData:
  ...
  if notes.strip():
    notesList = notes.split()
    lilypondCode = lilypondTemplate.substitute(trebleClefNotes=' , '.join([notesList[1].lower(), notesList[2].lower()]), \
